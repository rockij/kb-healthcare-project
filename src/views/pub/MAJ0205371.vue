  ...
  export default {
    setup() {
      const currentConnection = ref({
        title: 'HEM-7155T2',
        subtitle: 'Omron',
        path: '/assets/images/img-small-device-04.png'
      }) //연결된 기기 리스트

      const listNumber = ref([
        {
          path: 'img-device4-01.png',
          text: '건전지를 넣고 화면이 꺼진 상태에서 제품의 <span style="color: #3F86F1; font-weight: 600;">통신 또는 블루투스 버튼</span>을 2~3초 정도 눌러주세요.'
        },
        {
          path: 'img-device4-02.png',
          text: '제품화면에 <span style="color: #3F86F1; font-weight: 600;">P표시</span>가 뜹니다.'
        }
      ])
