<template>
  <div class="contents pb-0">
    <div class="pb-10 pt-3">
      ...
      <!-- //판정값 -->
      <h5 class="list-disease-item type icon-3 mt-6">총 콜레스테롤이</h5>
    ...
    <div class="section-page">
      <h4 class="fs-20 font-weight-bold d-flex align-center">
        <v-chip
          variant="outlined"
          label
          size="small"
      ...
      <h5 class="list-disease-item type icon-3 mt-6">LDL콜레스테롤이</h5>
      <ul class="list-updown-text mt-3 ml-8" :class="updwCount">
        <li v-for="(list, i) in updwList" :key="i">
          <span class="area"
            >{{ list.year }}전보다
    ...
    <div class="section-page">
      ...
      <h5 class="list-disease-item type icon-5 mt-6">LDL콜레스테롤이</h5>
      <ul class="list-updown-text mt-3 ml-8" :class="updwCount">
        <li v-for="(list, i) in updwList" :key="i">
          <span class="area"
            >{{ list.year }}전보다
