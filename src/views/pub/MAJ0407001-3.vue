  ...
  <div class="contents">
    <div class="challenge-section-spot">
      ...
      <div class="title-area">
        <p class="subTit-01">혈압 개선 전문 챌린지(야식형)</p>
        <span class="tags">
          <v-chip
            label
            size="small"
    ...
    <div ref="intro">
      <div class="challenge-section-content">
        ...
        <div class="example-img-area">
          ...
          <div class="img-box">
            <img src="@/assets/images/img-example2.png" alt="고혈압 개선 사례 이미지"/>
          </div>
        </div>
      ...
      const expertList = ref([
        {
          id: 1,
          number: '1',
          text: '전문적인 <strong class="point-blue">혈압</strong> 관리를 할 수 있어요!'
        },
        {
          id: 2,
          number: '2',
        ...
        },
        {
          id: 3,
          number: '3',
          text: '<strong class="point-blue">야식증후군</strong>을 극복하고 건강 습관을 만들어요!'
        }
      ])
