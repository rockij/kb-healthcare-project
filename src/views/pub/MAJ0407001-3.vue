<template>
  <div class="contents">
    <div class="challenge-section-spot">
      <div class="img-area">
        <img src="/assets/images/img-spot-challenge3.png" alt="" />
        <v-chip
          label
          size="small"
          color="primary"
      ...
      <div class="title-area">
        <div class="chip-title-area">
          <p class="subTit-01">혈압 개선 전문 챌린지</p>
          <!-- 
          ...
          -->
          <v-chip label class="chip-default chip-nightsnack-type">
            <span class="text-dot">야식형</span>
          </v-chip>
        </div>
        <span class="tags">
          <v-chip
