<template>
    <div class="contents">
        <div class="per-test-result-head">
            <div class="box">
                <div class="result-swipe">
                    ...
                    >
                        <Slide v-for="(item, index) in perCardList" :key="index" @click="documentModal=true">
                            <div class="card-img">
                                <img
                                    :src="`/src/assets/images/` + item.card"
                                />
                            </div>
                        </Slide>
                    </Carousel>
        ...
        <div class="per-test-result-list">
            <div class="per-test-result-item" v-for="(item, index) in resultList" :key="index">
                <div class="item-head">
                ...
                <div class="item-cont">
                    ...
                    <div class="per-chart-hor" ref="tarChart">
                        ...
                        <span class="bl high"><span>높음</span></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="my-expec-wrap">
                <div class="my-expec-head">
                    ...
                    <div class="my-expec-card-list">
                        <div class="my-expec-card-item" v-for="(item, index) in expecCardList" :key="index">
                            <v-img
                                :src="`/src/assets/images/` + item.card"
                            ></v-img>
                            <span class="lb">{{ item.lb }}</span>
                        </div>
                    </div>
                </div>
                <div class="my-expec-list">
                    <div class="my-expec-item" v-for="(item, index) in myExpecList" :key="index">
                        <div class="item-head">
                            <h3>{{ item.title }}</h3>
                        ...
                        <div class="item-cont">
                            ...
                            <div class="p-item-list">
                                <span class="p-item" v-for="(p, i) in item.point" :key="i">{{ p }}</span>
                            </div>
                            <div class="text-box">
                                <p>{{ item.text }}</p>
                            </div>
        ...
        <div class="section-page">
            <div class="per-link-share">
                <v-btn variant="text" class="btn-link-copy">성격특질검사<br>링크 복사<span>복사하기</span></v-btn>
                <v-btn variant="text" class="btn-sns-share">성격특질검사<br>공유하기<span>공유하기</span></v-btn>
            </div>
        </div>
        <div class="per-test-link">
            ...
            <ul class="per-test-link-list">
                <li>
                    <v-btn variant="text" class="test-link1">남이 보는<br>내 모습</v-btn>
                </li>
                <li>
                    <v-btn variant="text" class="test-link2">마음건강<br>검사</v-btn>
                </li>
                <li>
                    <v-btn variant="text" class="test-link3">심리상태<br>검사</v-btn>
                </li>
            </ul>
        </div>
        <div class="btn-bottom">
            <div class="btn-area d-flex">
                <v-btn variant="text" height="56" class="btn-summit">다시 검사하기</v-btn>
            </div>
        </div>
    </div>
    <!-- 모든성격유형 팝업 -->
