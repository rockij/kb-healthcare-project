<template>
  ...
  >
    <v-card>
        ...
        <div class="flex-shrink-0 modal-body-container">
          ...
          <div class="tabs-simple2 pt-1">
            <v-btn
              ...
              v-for="btn in btns2"
              :key="btn.value"
              :aria-selected="selected2.includes(btn)"
          ...
          <div class="tabs-simple2 pt-1">
            <v-btn
              ...
              v-for="btn in btns3"
              :key="btn.value"
              :aria-selected="selected3.includes(btn)"
      ...
      <v-card-actions>
        <v-btn height="48px" class="bdr-8 btn-yellow" block @click="onClicked"
          >확인</v-btn
        >
      </v-card-actions>
    </v-card>
