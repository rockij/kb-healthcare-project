  ...
  <div class="contents">
    <div class="challenge-section-spot">
      ...
      <div class="title-area">
        <p class="subTit-01">혈관건강 전문 챌린지(야식형)</p>
        <span class="tags">
          <v-chip
            label
            size="small"
    ...
    <div ref="intro">
      <div class="challenge-section-content">
        ...
        <div class="example-img-area">
          ...
          <div class="img-box">
            <img src="@/assets/images/img-example3.png" alt="이상지질혈증 개선 사례 이미지"/>
          </div>
        </div>
      ...
      const expertList = ref([
        {
          id: 1,
          number: '1',
          text: '전문적인 <strong class="point-blue">혈관건강</strong> 관리를 할 수 있어요!'
        },
        {
          id: 2,
          number: '2',
          text: '<strong class="point-blue">운동 러버</strong>도 쉽게 따라할 수 있어요!'
        },
        {
          id: 3,
          number: '3',
          text: '<strong class="point-blue">잦은 음주</strong>을 극복하고 건강 습관을 만들어요!'
        }
      ])
