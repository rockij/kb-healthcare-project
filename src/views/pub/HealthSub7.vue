<template>
  <div class="contents pt-0">
    <div class="textfield-area body-calendar pt-6 d-flex">
      <v-text-field
      ...
      <v-list-item class="consume-calorie">
        <v-list-item-title
          ><i class="icon-consume-calorie" aria-hidden="true"
            ><img src="/assets/images/icon-consume-calorie.svg" alt="" /></i
          ><span>소모 칼로리</span></v-list-item-title
        >
        <v-list-item-subtitle
          ><span ref="cnt-consume-calorie">--</span>kcal</v-list-item-subtitle
        >
      </v-list-item>

      <v-list-item class="textfield-area textfield-memo pt-4">
        <v-list-item-title
