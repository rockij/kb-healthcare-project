  ...
  export default {
    ...
    setup() {
      ...
      const SportsList = ref([
        {
          title: '시간대별 기록 확인',
          text: '시간대별 로 나의 혈압 정보를 알 수 있어요',
          iname: 'icon-noregi-bloodpressure01.svg'
        },
        {
          title: '혈압 ,맥박기록 확인',
          text: '혈압과 맥박 기록을  쉽게 확인 할 수 있어요',
          iname: 'icon-noregi-bloodpressure02.svg'
        },
        {
          title: '기간별 분석',
          text: '기간별  혈압,맥박 분석 정보를 제공해 드려요',
          iname: 'icon-noregi-bloodpressure03.svg'
        }
      ])
