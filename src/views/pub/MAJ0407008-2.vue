      ...
      <div class="auth-content">
        <div class="auth-content-top">
          ...
          <div class="button-area">
            ...
            <div class="tooltip-balloon arrow-bottom">측정시간 제한</div>
            <!-- // [D]측정시간 제한 툴팁 노출 on 클래스 -->
      ...
      <div class="auth-content">
        ...
        <div class="auth-content-bottom">
          ...
          <div class="auth-content-complete on">
            ...
            <!-- 인증 후 사진 삭제 영역 노출 on클래스 -->
            <div class="after-auth-img">
              <p class="after-auth-text">
                인증된 사진이 없어요. <br />
                다시 등록해볼까요?
              </p>
            </div>
          ...
          <!-- [D] // 인증 완료 노출 on 클래스 -->
          <div class="auth-content-area on">
            <p class="auth-content-text">
              <a href="javascript:;">
        ...
        <div class="auth-content-bottom">
          ...
          <div class="auth-content-complete on">
            ...
            <div class="complete-content">
              <v-btn variant="text" height="45" class="bdr-8 cancel" block>
                <!-- <template v-slot:prepend>
                    <img src="/assets/images/icon-challenge-yes.svg" class="ico-yes" alt="" />
                    <span class="btn-text">YES</span>
                    <img src="/assets/images/icon-photo-arrow.svg" alt="" />
                  </template> -->
                <template v-slot:prepend>
                  <img
                    src="/assets/images/icon-challenge-no.svg"
                    class="ico-no"
                    alt=""
                  />
