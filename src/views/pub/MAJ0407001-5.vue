<template>
  <div class="contents">
    <div class="challenge-section-spot">
      <div class="img-area">
        <img src="/assets/images/img-spot-challenge5.png" alt="" />
        <v-chip
          label
          size="small"
          color="primary"
      ...
      <div class="title-area">
        <div class="chip-title-area">
          <p class="subTit-01">체중감량 전문 챌린지</p>
          <!-- 
      ...
      <div class="challenge-section-content no-division">
        ...
        <div class="example-img-area">
          <strong class="example-title"
            >다이어트 핵심 요소인 운동과 식단!</strong
          >
          <p class="example-text">
            자연스럽게 식단을 지키고, 운동하는 습관을<br />
            형성할 수 있도록 매일 해야할 Todo를 알려드려요.
          </p>
          <p class="example-text">
            체중감량 효과는 물론, 건강 습관으로 일상을<br />
            채워드리는 것이 목표인 챌린지!
          </p>
        </div>
      </div>
    ...
    setup(props) {
      ...
      const expertList = ref([
        ...
        },
        {
          id: 2,
          number: '2',
          text: '<strong class="point-blue">건강체중</strong>을 위한 적절한 운동과 식단관리!'
        },
        {
          id: 3,
          number: '3',
          text: '건강하게 <strong class="point-blue">다이어트</strong>할 수 있는 생활 습관을 만들어요!'
        }
      ])
