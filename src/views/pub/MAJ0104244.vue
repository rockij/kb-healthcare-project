    ...
    <div class="contents">
        <div class="evt-temp">
            <div class="evt-temp-img">
                <img src="@/assets/images/event-ruleta1.png" alt="매일매일 룰렛 이벤트, 룰렛만 돌려도 포인트가 쏟아진다!, 2023.09.01 ~ 2023.09.30" />
            </div>
                        ...
                        <div class="evt-ruleta-wheel-wrap" ref="spinner">
                                    ...
                                    <div class="evt-ruleta-wheel" ref="ruletaWheel">
                                        <div class="pie-item"
                                            ...
                                            :style="`
                                                ...
                                                border-right-width : ${(rSize / 2)}px; 
                                                border-left-width : ${(rSize / 2)}px;
                                                transform : rotate(${pieDeg * (index + 1)}deg);
                                            `"
                                        >
                            ...
                            <div class="dot"
                                ...
                                :style="`
                                    transform : rotate(${pieDeg * (index + 1)}deg)
                                `"
                            ><span ref="dotItem"></span></div>
                        </div>
                        <button v-if="isEvt" type="button" class="btn-ruleta start" @click="clickEvt">START</button>
                        <span v-if="!isEvt" class="btn-ruleta end"><span>이벤트<br>종료</span></span>
                    </div>
                </div>
            </div>
            <div class="evt-temp-img">
        ...
        <v-dialog v-model="dialog" class="modal-dialog common-popup">
            ...
            <div class="modal-body">
                ...
                <template v-if="isWin">
                    ...
                    <div class="">지급된 선물은 선물함에서<br> 확인 할 수 있습니다.</div>
                </template>
                <template v-else>
