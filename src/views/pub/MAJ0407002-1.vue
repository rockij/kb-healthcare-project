<template>
  <div class="contents">
    <div class="challenge-section-spot">
      <div class="img-area">
        <img src="/assets/images/img-spot-challenge2.png" alt="" />
        <v-chip
          label
          size="small"
          color="primary"
    ...
    <div ref="intro">
      <div class="challenge-section-content">
        ...
        <div class="challenge-info-area">
          <p class="info-text">
            임상간호사, 임상영양사, 운동처방사가 건강습관개선, 질환예방 및
            관리를 위해 제작한 가이드라인을 따르는 챌린지입니다.
          </p>
          <img
        ...
        <div class="example-img-area">
          ...
          <p class="example-text">
            12개월간 총 150명의 당뇨병 환자를 대상으로 전문가 추천 서비스를 통한
            혈당 관리 유효성 검증 결과
          </p>
    ...
    <div class="btn-bottom">
      <div class="btn-area d-flex">
        <v-btn variant="text" height="56px" class="btn-summit">시작하기</v-btn>
      </div>
    </div>
  </div>
</template>
