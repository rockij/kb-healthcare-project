  ...
  <div class="contents">
    <div class="challenge-section-spot">
      ...
      <div class="title-area">
        <p class="subTit-01">혈당 개선 전문 챌린지(과식형)</p>
        <span class="tags">
          <v-chip
            label
            size="small"
    ...
    <div ref="intro">
      <div class="challenge-section-content">
        ...
        <div class="example-img-area">
          <strong class="example-title">임상으로 검증된 전문가 챌린지 효과</strong>
          <p class="example-text">
            12개월간 총 150명의 당뇨병 환자를 대상으로 전문가 추천 서비스를 통한 혈당 관리 유효성 검증 결과
          </p>
          <ul class="effect-list">
            <li v-for="list in effectList" :key="list.id">
              <span class="list-number">{{ list.number }}</span>
              <p class="list-text" v-html="list.text"></p>
            </li>
          </ul>
          <div class="img-box">
            <img src="@/assets/images/img-example1.png" alt="당뇨병 개선 사례 이미지"/>
          </div>
        </div>
        ...
        <div class="expert-challenge-area">
          ...
          <ul class="expert-challenge-list">
            <li class="list-item">
              <img src="@/assets/images/icon-expert-challenge1.svg" alt="" class="mr-4" />
              <span>
            ...
            <li class="list-item">
              <img src="@/assets/images/icon-expert-challenge2.svg" alt="" class="mr-4" />
              <span>
    ...
    <div class="btn-bottom">
      <div class="btn-area d-flex">
        <v-btn variant="text" height="56px" class="btn-summit">1주 체험하기</v-btn>
      </div>
    </div>
  </div>
</template>
      ...
      const expertList = ref([
        {
          id: 1,
          number: '1',
          text: '전문적인 <strong class="point-blue">혈당</strong> 관리를 할 수 있어요!'
        },
        {
          id: 2,
          number: '2',
          text: '<strong class="point-blue">운동 초보</strong>도 쉽게 따라할 수 있어요!'
        },
        {
          id: 3,
          number: '3',
          text: '<strong class="point-blue">잦은 과식</strong>을 조절하고 건강 습관을 만들어요!'
        }
      ])
      const effectList = ref([
        {
          id: 1,
          number: '1',
          text: '당화혈색소 평균 <strong class="point-blue">0.63%p 강하</strong>'
        },
        {
          id: 2,
          number: '2',
          text: '건강한 관리 습관 형성하면(3개월),<br /><strong class="point-blue">1년 동안 유지 가능</strong>'
        },
      ])
