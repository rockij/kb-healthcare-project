  ...
  <div class="contents pt-0">
    <div class="section-page bg pa-4">
      <v-card
        variant="flat"
        rounded="xl"
        class="px-4 py-6 text-center overflow-visible"
      >
        <div class="btn-area2 grid-column-2">
          <div class="text text-grey">혈당을 측정해 보세요</div>
          <v-btn
            variant="text"
            height="46px"
    ...
    <div class="textfield-area body-calendar pt-8 d-flex">
      <v-text-field
      ...
      <v-list-item class="textfield-area textfield-memo mt-2">
        <v-list-item-title
          ><span class="font-weight-bold">측정 상태</span></v-list-item-title
        >
      ...
      <div class="box-rounded-fill">
        <p class="table-caution">아침 기상 직후 또는 8시간 이상 공복 기준</p>
      </div>
      ...
      <v-list-item class="textfield-area pa-0">
        <v-list-item-title
          >오늘 먹은 음식<span class="small">(선택)</span></v-list-item-title
        >
