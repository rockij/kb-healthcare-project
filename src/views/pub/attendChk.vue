    ...
    <div class="contents">
        <div class="evt-temp">
            ...
            <div class="evt-temp-cont">
                <div class="evt-attend-chk" style="background-image: url(/src/assets/images/event-attend-bg.png);">
                        ...
                        <ul class="evt-attend-chk-list">
                            ...
                            >
                                <button type="button" class="stamp" @click="evtAttend(index)">
                                    ...
                                    <span v-if="item.isChk && !item.point.state" class="stamp-chk"><span class="offscreen">출석<br>완료</span></span>
